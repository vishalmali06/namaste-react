...
const resList = [
    ...
    },
    {
        "info": {
            "id": "588012",
            "name": "SMOOR",
            "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2024/6/11/6f4271cd-1137-4287-9bc9-414ef71743cf_588012.JPG",
    ...
    return (
        <div className='body'>
            ...
            <div className='res-container'>
                {
                    resList.map((restaurant) => <RestaurantCard key={restaurant.info.id} restData={restaurant} />)
                }
            </div>
        </div>
    );
